...
As mentioned above, please ensure any relevant information/print that is generated during the script is correctly forwarded to the destination of the `$log` file.
