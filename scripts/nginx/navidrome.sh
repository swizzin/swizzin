...
sed -r 's|Address = (.*)|http_host = 127.0.0.1|g' -i "/home/${user}/.config/navidrome/navidrome.toml"
sed -r 's|BaseUrl = (.*)|http_root = /navidrome|g' -i "/home/${user}/.config/navidrome/navidrome.toml"
