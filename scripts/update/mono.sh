...
echo "Downgrading mono to $version repository version"
...
PACKAGES=(ca-certificates-mono libmono-2.0-1 libmono-2.0-dev libmono-accessibility4.0-cil libmono-cairo4.0-cil libmono-cecil-private-cil 
  libmono-cil-dev libmono-codecontracts4.0-cil libmono-compilerservices-symbolwriter4.0-cil libmono-corlib4.5-cil 
  ...
  libmono-profiler libmono-rabbitmq4.0-cil libmono-relaxng4.0-cil libmono-security4.0-cil libmono-sharpzip4.84-cil libmono-simd4.0-cil 
  ...
  libmono-system-core4.0-cil libmono-system-data-datasetextensions4.0-cil libmono-system-data-entity4.0-cil 
  libmono-system-data-linq4.0-cil libmono-system-data-services-client4.0-cil libmono-system-data-services4.0-cil 
  libmono-system-data4.0-cil libmono-system-design4.0-cil libmono-system-drawing-design4.0-cil libmono-system-drawing4.0-cil 
  ...
  libmono-system-windows4.0-cil libmono-system-xaml4.0-cil libmono-system-xml-linq4.0-cil libmono-system-xml-serialization4.0-cil 
  libmono-system-xml4.0-cil libmono-system4.0-cil libmono-tasklets4.0-cil libmono-webbrowser4.0-cil libmono-webmatrix-data4.0-cil 
  libmono-windowsbase4.0-cil libmono-xbuild-tasks4.0-cil libmonoboehm-2.0-1 mono-4.0-gac mono-4.0-service mono-complete mono-csharp-shell mono-devel 
  mono-gac mono-jay mono-mcs mono-runtime mono-runtime-common mono-runtime-sgen mono-utils mono-xbuild monodoc-base monodoc-manual)

NR=(libmono-system-deployment4.0-cil libmono-system-numerics-vectors4.0-cil libmono-system-reflection-context4.0-cil 
  libmono-system-web-mobile4.0-cil libmono-system-web-regularexpressions4.0-cil libmono-system-workflow-activities4.0-cil 
  libmono-system-workflow-componentmodel4.0-cil libmono-system-workflow-runtime4.0-cil mono-roslyn)
elif [[ $version == "jessie" ]]; then
version=master
PACKAGES=(ca-certificates-mono libmono-2.0-dev libmono-accessibility4.0-cil libmono-cairo4.0-cil 
  ...
  libmono-i18n-mideast4.0-cil libmono-i18n-other4.0-cil libmono-i18n-rare4.0-cil 
  libmono-i18n-west4.0-cil libmono-i18n4.0-all libmono-i18n4.0-cil libmono-ldap4.0-cil 
  ...
  libmono-peapi4.0a-cil libmono-posix4.0-cil libmono-rabbitmq4.0-cil libmono-relaxng4.0-cil 
  ...
  libmono-system-data-services4.0-cil libmono-system-data4.0-cil libmono-system-design4.0-cil 
  ...
  libmono-system-json4.0-cil libmono-system-ldap-protocols4.0-cil libmono-system-ldap4.0-cil 
  libmono-system-management4.0-cil libmono-system-messaging4.0-cil 
  libmono-system-net-http-formatting4.0-cil libmono-system-net-http-webrequest4.0-cil 
  libmono-system-net-http4.0-cil libmono-system-net4.0-cil libmono-system-numerics4.0-cil 
  ...
  libmono-system-reactive-platformservices2.2-cil libmono-system-reactive-providers2.2-cil 
  libmono-system-reactive-runtime-remoting2.2-cil libmono-system-reactive-windows-forms2.2-cil 
  libmono-system-reactive-windows-threading2.2-cil libmono-system-runtime-caching4.0-cil 
  ...
  libmono-system-web-mvc3.0-cil libmono-system-web-razor2.0-cil libmono-system-web-routing4.0-cil 
  ...
  libmono-system-web4.0-cil libmono-system-windows-forms-datavisualization4.0a-cil 
  libmono-system-windows-forms4.0-cil libmono-system-windows4.0-cil libmono-system-xaml4.0-cil 
  ...
  libmono-webmatrix-data4.0-cil libmono-windowsbase4.0-cil libmono-xbuild-tasks4.0-cil mono-4.0-gac 
  mono-devel mono-gac mono-mcs mono-runtime mono-runtime-common mono-runtime-sgen mono-xbuild)

NR=(libmono-system-deployment4.0-cil{u} libmono-system-numerics-vectors4.0-cil{u} 
  libmono-system-reflection-context4.0-cil{u} libmono-system-web-mobile4.0-cil{u} 
  libmono-system-web-regularexpressions4.0-cil{u} libmono-system-workflow-activities4.0-cil{u} 
  libmono-system-workflow-componentmodel4.0-cil{u} libmono-system-workflow-runtime4.0-cil{u} 
  libmonosgen-2.0-dev{u} mono-roslyn{a})
else 
